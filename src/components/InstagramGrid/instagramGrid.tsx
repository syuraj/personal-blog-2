...
import { InstagramGridWrapper, PostImage, PostMeta, Overlay, MetaItem, MetaIcon, MetaText } from './instagramGrid.style'
...
const InstagramGrid: React.FunctionComponent<InstagramGridProps> = ({ image, alt, like, comment, url }) => {
	return (
